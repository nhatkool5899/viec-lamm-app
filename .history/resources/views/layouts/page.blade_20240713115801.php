            ...
            <div class="header">
                <div class="header__container container">
                    ...
                    <div class="header__right">
                        ...
                        <a href="#c" class="button__primary black">
                ...
                <div class="container">
                    <div class="flex">
                        <div class="ft__col-3">
                            ...
                            <div class="ft__context">
                                <div class="ft__inner">
                                    <span>
                                        Hotline:
                                    </span>
                                    <a href="#">(024) 6680 5588 (Giờ hành chính)</a>
                                </div>
                                <div class="ft__inner">
                                    <span>
                                        Email:
                                    </span>
                                    <a href="#">hotro@topcv.vn</a>
                                </div>
                            </div>
                        ...
                        <div class="ft__col-7">
                            <div class="ft__grid">
                                <div class="ft__grid-col">
                                    <div class="ft__title">Về chúng tôi</div>
                                    <a href="#1" class="ft__link">Giới thiệu</a>
                                    <a href="#1" class="ft__link">Góc báo chí</a>
                                    <a href="#1" class="ft__link">Tuyển dụng</a>
                                    <a href="#1" class="ft__link">Chính sách bảo mật</a>
                                    <a href="#1" class="ft__link">Quy chế hoạt động</a>
                                </div>
                                <div class="ft__grid-col">
                                    <div class="ft__title">Về chúng tôi</div>
                                    <a href="#1" class="ft__link">Giới thiệu</a>
                    ...
                    <div class="ft__bottom">
                        <div class="ft__head-title">Công ty Cổ phần TopCV Việt Nam</div>
                        <div class="ft__company">
                            <i class='bx bx-file' ></i>
                            Giấy phép đăng ký kinh doanh số:
                            <span>0107307178</span>
                        </div>
                        <div class="ft__company">
                            <i class='bx bxs-file-blank' ></i>
                            Giấy phép hoạt động dịch vụ việc làm số:
                            <span>18/SLĐTBXH-GP</span>
                        </div>
                        <div class="ft__company">
                            <i class='bx bxs-building-house' ></i>
                            Trụ sở HN:
                            <span>Tòa FS - GoldSeason số 47 Nguyễn Tuân, P.Thanh Xuân Trung, Q.Thanh Xuân, Hà Nội</span>
                        </div>
                    </div>
                </div>
            </div>
