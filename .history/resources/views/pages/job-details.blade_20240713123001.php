            ...
            <div class="flex" style="gap: 30px">
                <div class="col-lg-8">
                    <div class="box__group">
                        <div class="details__title">{{$job['jobTitle']}}</div>
                ...
                <div class="col-lg-4">
                    <div class="box__group">
                        <a href="#" class="company__head">
                            <img src="{{$job['employer']['logo']}}" alt="image">
                        ...
                        <div class="company__view">
                            <a href="{{url('cong-ty/123')}}" class="company__link">Xem thêm về công ty <i class='bx bx-link' ></i></a>
                        </div>
                    </div>
                </div>
            </div>
