                    ...
                    <div class="col-lg-8">
                        <div class="box__group">
                            <div class="job__details-head">
                                ...
                                <span><i class='bx bx-bell' ></i> Gửi tôi việc làm tương tự</span>
                            </div>
                            <div class="jobs__details-content">
                                <div class="jobs__details-title">Mô tả công việc</div>
                                <ul>
                            ...
                            <div class="jobs__details-content">
                                <div class="jobs__details-title">Yêu cầu ứng viên</div>
                                <ul>
                            ...
                            <div class="jobs__details-content">
                                <div class="jobs__details-title">Quyền lợi</div>
                                <ul>
                            ...
                            <div class="jobs__details-content">
                                <div class="jobs__details-title">Địa điểm làm việc</div>
                                <ul>
                                    <li>Hà Nội: Tầng 1 G4 tòa nhà Five Star Garden, số 2 đường Kim Giang, P. Kim Giang, Thanh Xuân</li>
                                </ul>
                            </div>
                            <div class="jobs__details-content">
                                <div class="jobs__details-title">Thời gian làm việc</div>
                                <ul>
